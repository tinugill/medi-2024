...
@Component({
  selector: 'app-dashboard-bloodbank',
  templateUrl: './dashboard-bloodbank.component.html',
  styleUrls: ['./dashboard-bloodbank.component.scss'],
})
export class DashboardBloodbankComponent implements OnInit {
  constructor(
