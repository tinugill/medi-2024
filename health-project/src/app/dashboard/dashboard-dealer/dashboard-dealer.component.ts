...
@Component({
  selector: 'app-dashboard-dealer',
  templateUrl: './dashboard-dealer.component.html',
  styleUrls: ['./dashboard-dealer.component.scss']
})
export class DashboardDealerComponent implements OnInit {
