    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Discount
                    <div class="page-title-subheading">List of Discount
                    </div>
                </div>
            </div>
                        ...
                        <table class="mb-0 table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('listing_discount_list.destroy',$value->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-warning">Delete</button>
                                        </form>

                                        <a href="{{route('listing_discount_list.edit',$value->id)}}">
