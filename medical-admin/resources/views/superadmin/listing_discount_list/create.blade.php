...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            @if($id)
            <form class="needs-validation" novalidate method="POST" action="{{route('listing_discount_list.update',$id)}}">
                @method('PUT')
                @else
                <form class="needs-validation" novalidate method="POST" action="{{route('listing_discount_list.store')}}">
                    @endif
                    @csrf
                    <div class="form-row">
                        @if($id)
                        ...
                        @endif
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom02">Coupon code </label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="validationCustom02" value="@if($id){{Optional($special)->discount}}@endif" name="discount" placeholder="Enter value" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
