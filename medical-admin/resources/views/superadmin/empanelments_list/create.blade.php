...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Create Empanelments</h5>
            @if($id)
            <form class="needs-validation" novalidate method="POST" action="{{route('empanelments_list.update',$id)}}">
                @method('PUT')
                @else
                <form class="needs-validation" novalidate method="POST" action="{{route('empanelments_list.store')}}">
                    @endif
                    @csrf
                    <div class="form-row">
                        @if($id)
                        ...
                        @endif
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom02">Empanelment Name </label>
