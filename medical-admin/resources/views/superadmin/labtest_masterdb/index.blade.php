    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Labtest
                    <div class="page-title-subheading">List of Labtest
                    </div>
                </div>
            </div>
                        ...
                        <table class="mb-0 table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('labtest_masterdb.destroy',$value->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-warning">Delete</button>
                                        </form>

                                        <a href="{{route('labtest_masterdb.edit',$value->id)}}">
