...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Create Facility</h5>
            @if($id)
            <form class="needs-validation" novalidate method="POST" action="{{route('facility_list.update',$id)}}">
                @method('PUT')
                @else
                <form class="needs-validation" novalidate method="POST" action="{{route('facility_list.store')}}">
                    @endif
                    @csrf
                    <div class="form-row">
                        @if($id)
