...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Create equipment Category</h5>
            @if($id)
            <form class="needs-validation" novalidate method="POST" action="{{route('categoryEqp.update',$id)}}" enctype="multipart/form-data">
                @method('PUT')
                @else
                <form class="needs-validation" novalidate method="POST" action="{{route('categoryEqp.store')}}" enctype="multipart/form-data">
                    @endif
                    @csrf
                    <div class="form-row">
                        ...
                        <!-- <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="@if($id){{Optional($category)->description}}@endif" name="description" placeholder="Enter Description" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div> -->
