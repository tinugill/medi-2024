...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            @if($id)
            <form class="needs-validation" novalidate method="POST" action="{{route('designation.update',$id)}}">
                @method('PUT')
                @else
                <form class="needs-validation" novalidate method="POST" action="{{route('designation.store')}}">
                    @endif
                    @csrf
                    <div class="form-row">
                        @if($id)
                        <div class="col-md-6 mb-3">
                            <label>Status</label>
                            <select type="text" class="form-control" name="is_approved" placeholder="Enter Status" required>
                        ...
                        @endif
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom02">Designation Name </label>
